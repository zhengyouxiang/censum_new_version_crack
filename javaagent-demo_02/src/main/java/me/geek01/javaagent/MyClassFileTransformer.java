...
public class MyClassFileTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classBytes) throws IllegalClassFormatException {
        if (className.equals("com/jclarity/censum/Censum")) {
    ...
    public static class MyClassVisitor extends ClassVisitor {
        ...
        public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
            ...
            if (name.equals("checkLicense")) {
                return new MyMethodVisitor3(mv, access, name, desc);
            }
            return mv;
        }
    }

    public static class MyMethodVisitor3 extends AdviceAdapter {

        protected MyMethodVisitor3(MethodVisitor mv, int access, String name, String desc) {
